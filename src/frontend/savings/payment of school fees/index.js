...
const PaymentOfSchoolFees = ({navigation}) => {
    return (
        <View style={style.container}>
            <View style={style.topName}>
                ...
                <Text style={style.topNameTxt}>Brighten Your Education</Text>
            </View>        
            ...
            <View style={{backgroundColor: '#fff', padding: 10, borderRadius: 10, marginTop: 10}}>
                ...
                <Text  style={{alignSelf:'center', marginTop: 15}}>Education is the key to success</Text>
...
export default PaymentOfSchoolFees;